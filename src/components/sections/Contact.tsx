import { Copy, Github, LucideLinkedin, Mail, PhoneIcon } from "lucide-react";
    ...
    <div className="cursor-default">
      <div className="mb-16">
        ...
        <div className="flex flex-row items-center pb-8">
          ...
          <div className="px-2"><Button variant='ghost'><Copy width={15} height={15} className="text-neutral-600 dark:text-neutral-400"/></Button> </div>
        </div>
        ...
        <div className="flex flex-row items-center pb-8">
          ...
          <div className="px-2 cursor-pointer"><Button variant='ghost'><Copy width={15} height={15} className="text-neutral-600 dark:text-neutral-400"/></Button> </div>
        </div>
